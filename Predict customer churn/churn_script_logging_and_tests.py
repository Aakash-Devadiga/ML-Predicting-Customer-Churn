...
def test_encoder_helper(encoder_helper):    
	...
	'''
    try:
        encoder_helper(dataframe,encoder_category_list)
    ...
    try:
        dataframe_new = encoder_helper(dataframe, encoder_category_list)
        for i in dataframe_new.columns:
...
def test_train_models(train_models):
	...
	'''
    try:
        X_train, X_test, y_train, y_test = cls.perform_feature_engineering(dataframe_encoded)
...
dataframe_encoded = cls.encoder_helper(dataframe, encoder_category_list)
